...
from wtforms import StringField, SubmitField, PasswordField, DateField, TextAreaField, FloatField, SelectField
...
class FormCriarContaProfissional(FlaskForm):
    ...
    def validate_email(self, email):
        ...
        if email:
            raise ValidationError(f"Email {email.data} já cadastrado, faça login para entrar no site")
