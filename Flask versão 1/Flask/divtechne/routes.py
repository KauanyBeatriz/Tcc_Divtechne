...
def projetos():
    ...
    return render_template("projetos.html", projetos=projeto, form_vaga=formcriarvaga, form_servico=formcriarservico, form_projeto=formcriarprojeto, form_editar_senha=formeditarsenha)
...
def vagas():
    ...
    return render_template("vagas.html", vagas=vaga, form_vaga=formcriarvaga, form_servico=formcriarservico, form_projeto=formcriarprojeto, form_editar_senha=formeditarsenha)
...
def servicos():
    ...
    return render_template("servicos.html", servicos=servico, form_vaga=formcriarvaga, form_servico=formcriarservico, form_projeto=formcriarprojeto, form_editar_senha=formeditarsenha)
...
def perfil_profissional(id_profissional):
    ...
    return render_template("perfil_profissional.html", profissional=profissional, form_vaga=formcriarvaga, form_servico=formcriarservico, form_projeto=formcriarprojeto, form_editar_senha=formeditarsenha)
...
def seguindo(id_cliente):
    ...
    return render_template("seguindo.html", cliente=cliente, profissional=profissional, form_vaga=formcriarvaga, form_servico=formcriarservico, form_projeto=formcriarprojeto, form_editar_senha=formeditarsenha)
